...
//.spit() - this divides the string based on the passed in character (will default to an array that splits at each character and add in commas). 
...
// #5 Given the array candies and the integer extraCandies, where candies[i] represents the number of candies that the -ith kid has.
